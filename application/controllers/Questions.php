    ...
    public function get_daily_quiz() {
        ...
        if ($data) {
            ...
            foreach ($res as $question) {
                $html .= "<li id=" . $question->id . " class='ui-state-default ui-sortable-handle'>" . $question->id . ". " . $question->question . "<a class='btn btn-danger btn-sm remove-row float-right'>x</a></li>";
            }
