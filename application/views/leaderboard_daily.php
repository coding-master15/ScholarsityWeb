...
<html lang="en">
    <head>        
        ...
        <title>Daily Leaderboard Details | <?php echo ($app_name) ? $app_name['message'] : "" ?></title>   
                ...
                <div class="main-content">
                    <section class="section">
                        <div class="section-header">
                            <h1>Daily Leaderboard Details <small>View day wise leaderboard</small></h1>
                        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body"> 
                                            <table aria-describedby="mydesc" class='table-striped' id='daily_leaderboard' 
                                                   data-toggle="table" data-url="<?= base_url() . 'Table/daily_leaderboard' ?>"
