        ...
        <script>
            ...
            $('#add_question').on('click', function (e) {
                ...
                $.each(questions, function (i, v) {
                    li = $("<li id='" + questions[i].id + "'' class='ui-state-default'/>").text(questions[i].id + ". " + questions[i].question).append("<a class='btn btn-danger btn-sm remove-row float-right'>x</a>");
